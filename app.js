...
Ext.application({
    ...
    views: ['settingapp', 'MyAccount.UserAcc', 'MyAccount.singlesummary', 'MyAccount.singlesummarypanel', 'regAccount', 'functionality.funct', 'functionality.routine', 'about.abouts', 'about.panelabout', 'about.aboutapp',
        ...
        'TraceAlertFence.Gmaphistory', 'TraceAlertFence.listTraceAlertFence', 'custompanel.gMapHistory_BottomPanelinfo', 'TraceAlertFence.holderTraceAlertFence', 'custompanel.master_usermanual', 'custompanel.splashLogo',
